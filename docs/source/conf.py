...
# wind_power_forecasting documentation build
...
from wind_power_forecasting import __version__ as release

# -- Project information -----------------------------------------------------

project = "wind_power_forecasting"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "wind_power_forecastingdoc"
...
latex_documents = [
    (
        master_doc,
        "wind_power_forecasting.tex",
        "wind_power_forecasting Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "wind_power_forecasting",
        "Project wind_power_forecasting codebase.",
        "Data-Science",
    )
]
